...
#define EEP_APERTURE_LIST_OFFSET    256
...
// DP: 'QEvent' and 'EOSConsole' definitions only relevant for computer side user input
...
void CamStateHandlers::OnDeviceDisconnectedState(PTP *ptp)
{
    if (stateConnected == stConnected || stateConnected == stInitial)
    {
        ...
        //  DP: Following bit only relevant for computer-side user input.
        /*
...
void CamStateHandlers::OnDeviceInitializedState(PTP *ptp)
{
    ...
    if (stateConnected == stDisconnected || stateConnected == stInitial)
    {
        ...
        // DP: Following line only relevant for computer-side user input.
        //eosConsole.dispatch(&evtTick);
    ...
    if (time_now >= next_time)
    {
        ...
        // DP: the following bit is only relevant for computer-side user input.
        // receiving values from camera works without it.
...
void setup()
{
    ...
    // DP: Following lines only relevant for computer-side user input.
